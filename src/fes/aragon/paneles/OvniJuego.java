...
public class OvniJuego extends JFrame implements Pintar, ActionListener {
    ...
    public OvniJuego(String nombreArchivo, int numeroFrames, Component componente, int x, int y) {
        ...
        for (int i = 1; i < numeroFrames; i++) {
            Image imagen = herram.getImage(getClass().getResource("/fes/aragon/recursos/" + nombreArchivo + "/" + nombreArchivo + " (" + i + ").png"));
            imagenes.add(imagen);
        ...
        laser = java.applet.Applet.newAudioClip(getClass().getResource("/fes/aragon/recursos/laser.wav"));
        audioFondo = java.applet.Applet.newAudioClip(getClass().getResource("/fes/aragon/recursos/fondoJuego.wav"));
        audioGanaste = java.applet.Applet.newAudioClip(getClass().getResource("/fes/aragon/recursos/juegoGanaste.wav"));
        audioPerdiste = java.applet.Applet.newAudioClip(getClass().getResource("/fes/aragon/recursos/juegoPerdiste.wav"));
        audioFondo.loop();
    }
    ...
    public void pintar(Graphics g) {
        ...
        Image image = herrami.getImage(getClass().getResource("/fes/aragon/recursos/gameOver.png"));
        Image image2 = herrami.getImage(getClass().getResource("/fes/aragon/recursos/complete.png"));
        Image image3 = herrami.getImage(getClass().getResource("/fes/aragon/recursos/misionc.gif"));
        if(perdiste){
