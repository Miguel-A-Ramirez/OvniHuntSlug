...
public class naveAdelante implements Pintar{
    ...
    public naveAdelante(String nombreArchivo, int numeroFrames, Component componente, int x, int y) {
...
@Override
    public void pintar(Graphics g) {
        ...
        g.drawImage(imagenes.get(indice), x, y-80, 600, 205, null);
        indice++;
