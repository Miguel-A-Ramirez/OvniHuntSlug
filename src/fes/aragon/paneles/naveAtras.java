...
public class naveAtras implements Pintar{
    ...
    public naveAtras(String nombreArchivo, int numeroFrames, Component componente, int x, int y) {
...
@Override
    public void pintar(Graphics g) {
        ...
        g.drawImage(imagenes.get(indice), x, -80, 600, 205, null);
        indice++;
